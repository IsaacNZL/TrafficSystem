...
classNames = []
classFile = r'C:\Users\nct3743\PycharmProjects\YOLOtraining\Object_Detection_Files\coco.names'
with open(classFile, "rt") as f:
    classNames = f.read().rstrip("\n").split("\n")

# This is to pull the information about what each object should look like
configPath = r'C:\Users\nct3743\PycharmProjects\YOLOtraining\Object_Detection_Files\ssd_mobilenet_v3_large_coco_2020_01_14.pbtxt'
weightsPath = r'C:\Users\nct3743\PycharmProjects\YOLOtraining\Object_Detection_Files\frozen_inference_graph.pb'
...
# Load the video file
video_path = r'C:\Users\nct3743\PycharmProjects\Embedded Project\TrafficLight.mp4'  # Update with the correct path to your video
...
while True:
    ...
    result, objectInfo = getObjects(frame, 0.6, 0.2, objects=['car', 'motorcycle', 'bus', 'bicycle'])
    ...
    print(f"Cars: {car_count}, Buses: {bus_count}, Motorcycles: {motorcycle_count}, Bicycles: {bicycle_count}")
