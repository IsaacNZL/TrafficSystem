...
c.execute("DELETE FROM TrafficCam2")
db_conn.commit()
...
classNames = []
classFile = r'/home/pi/Desktop/Object_Detection_Files/coco.names'
with open(classFile, "rt") as f:
    classNames = f.read().rstrip("\n").split("\n")

# This is to pull the information about what each object should look like
configPath = r'/home/pi/Desktop/Object_Detection_Files/ssd_mobilenet_v3_large_coco_2020_01_14.pbtxt'
weightsPath = r'/home/pi/Desktop/Object_Detection_Files/frozen_inference_graph.pb'
...
try:
    while True:
        ...
        if not processed_frame_queue.empty():
            ...
            c.execute(
                "INSERT INTO TrafficCam2 (VehicleCount, Date, Time, Car, Bus, Motorbike) VALUES (%s, %s, %s, %s, %s, %s)",
